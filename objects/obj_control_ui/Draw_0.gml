...
else if obj_control_main.gameMode == "status"
{
	draw_set_font(font_vcr_20)
	if obj_control_main.levelClear == "clear"
	{
			func_text_outline(258-128, 60-16,"MISSION SUCCESSFUL" , c_lime,c_green);
	}
	else if obj_control_main.levelClear == "fail"
	{
			func_text_outline(258-128+24, 60-16,"MISSION FAILED", c_lime,c_green);
	}
	func_text_outline(258, 76+32*0, obj_control_main.levelName, c_lime,c_green);
	func_text_outline(258, 76+32*1, obj_control_main.gameTime, c_lime,c_green);
	func_text_outline(258, 76+32*2, obj_control_main.enemyTotal, c_lime,c_green);
	func_text_outline(258, 76+32*3, obj_control_main.secrectNum, c_lime,c_green);
	func_text_outline(258, 76+32*4, obj_control_main.difficulty, c_lime,c_green);
	func_text_outline(258-128-8, 76+32*5, "PRESS F1 TO RESTART", c_lime,c_green);
}